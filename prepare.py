...
KAYMODB_PATH = f'{PATH}/datasets/kaymodb/'

def prepare_emodb():
    emodb_path = f'{PATH}/datasets/emodb/wav/'
    ...
    for wav_file in wav_data:
        ...
        # print(emodb_path + wav_file, emotion_path + f'/0_emodb_{EMOTIONS[emotion]}_{emotion_count[EMOTIONS[emotion]]}.wav')
        shutil.copy(emodb_path + wav_file, emotion_path + f'/0_emodb_{EMOTIONS[emotion]}_{emotion_count[EMOTIONS[emotion]]}.wav')
